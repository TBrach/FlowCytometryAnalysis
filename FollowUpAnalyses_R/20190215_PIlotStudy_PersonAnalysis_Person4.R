...
stool_data <- read.csv2(file = file.path(datapath, "00_Template_SampleCollectionSheet_P4.csv"), header = TRUE, sep = ";",
...
# pdf(file = "TimePoint_Plot_VolumeFromBeads_Person4.pdf", width = 6, height = 4.5)
# Tr
# dev.off()
# --
...
# pdf(file = "TimePoint_Plot_VolumeFromFR_Person4.pdf", width = 6, height = 4.5)
# Tr
# dev.off()
# --
