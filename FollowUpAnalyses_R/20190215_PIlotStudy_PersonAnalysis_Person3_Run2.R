...
sampleName <- "20190215_PilotStudy_Person3_Run2_results.rds"
...
# pdf(file = "TimePoint_Plot_VolumeFromBeads_Person3_Run2.pdf", width = 6, height = 4.5)
# Tr
# dev.off()
# --
...
savename <- paste0(as.Date(now()), "_CountAnalysis_", Person, "_Run2.rds")
