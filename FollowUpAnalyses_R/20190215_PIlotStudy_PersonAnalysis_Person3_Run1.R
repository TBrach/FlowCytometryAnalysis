...
sampleName <- "20190215_PilotStudy_Person3_Run1_results.rds"
...
stool_data <- read.csv2(file = file.path(datapath, "00_Template_SampleCollectionSheet_P3.csv"), header = TRUE, sep = ";",
...
# - ATTENTION: In this run 2 wells did not work -
DF <- DF[!DF$Tube %in% c("B7", "G7"), ]
# --
...
# pdf(file = "TimePoint_Plot_VolumeFromBeads_Person3.pdf", width = 6, height = 4.5)
# Tr
# dev.off()
# --
...
# pdf(file = "TimePoint_Plot_VolumeFromFR_Person3.pdf", width = 6, height = 4.5)
# Tr
# dev.off()
# --
