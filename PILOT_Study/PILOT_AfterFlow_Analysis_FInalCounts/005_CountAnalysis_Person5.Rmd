# Count analysis person 5

- **NB: We might want to exclude person 5 since it was run first still with the old protocol that including washing/spinning steps!!!**
- However probably the data is not that different so it can be included
...
stool_data <- read.csv2(file = file.path(sample_collection_path, "00_Template_SampleCollectionSheet_P5.csv"), header = TRUE, sep = ";",
