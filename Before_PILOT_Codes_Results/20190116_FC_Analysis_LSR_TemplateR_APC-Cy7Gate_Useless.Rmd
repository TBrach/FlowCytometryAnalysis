...
## Gate 2: Polynomial gate on Pacific Blue-A APC-Cy7-A plots



### Pacific Blue-A APC-Cy7-A plots with polygon

- Pacific Blue-A detects the DAPI
- APC-Cy7-A is a > 670 nm longpass filter
...
TrL2 <- FC.geom_hex(fs = getData(gs, "/Area"), x = "Pacific Blue-A", y = "FSC-A", bins = bins, co.fix = TRUE, xlimits = c(0.1, 300000), ylimits = c(.1,300000), trans = "log10", colPalette = NULL, ncolors = 10)
...
### Check FSC-H, SSC-H of the cells
...
## Gate 4: Polynomial/Rectangular gate on PE-A Pacific Blue-A
