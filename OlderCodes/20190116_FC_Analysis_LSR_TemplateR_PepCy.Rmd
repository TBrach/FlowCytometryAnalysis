...
Poly <- data.frame(x = c(600, 100000, 100000, 8000, 600), y = c(10, 10, 3000, 3000,100))
# ----
...
### Pacific Blue-A PerCP-Cy5-5-A plots with polygon
...
matr <- as.matrix(Poly)
colnames(matr) <- c("Pacific Blue-A", "PerCP-Cy5-5-A")
