...
files <- c("20190305_DIRECT_Plate10_results.rds", "20190305_DIRECT_Plate10C3_results.rds")
# --
...
resL <- readRDS(file = file.path(datapath, "20190305_DIRECT_Plate10_results.rds"))
resL[["res_DF"]] <- df_both
saveRDS(resL, file = file.path(datapath, "20190305_DIRECT_Plate10_results.rds"))
# --
